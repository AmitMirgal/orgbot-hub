...
export const metadata: Metadata = {
  ...
  description: "A company of bots you can install. Front desk plus named seats. Official Grok only.",
};
        ...
        <Providers>
          ...
          <footer className="border-t border-border">
            <p className="mx-auto flex max-w-6xl flex-wrap items-center gap-x-4 gap-y-2 px-4 py-4 text-[12px] text-muted-foreground">
              <span>Packs are companies of named chats. Install is official Grok only.</span>
